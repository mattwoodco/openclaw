...
# Send an HTML email
gws gmail +send --to alice@example.com --subject 'Welcome' --body '<h1>Welcome!</h1><p>You are all set.</p>' --html

# Send with CC, BCC
gws gmail +send --to alice@example.com --cc bob@example.com --subject 'Hello' --body 'Hi!'
...
gws gmail +read MSG_ID

# Reply to a message
gws gmail +reply MSG_ID --body 'Thanks for the update!'

# Reply-all
gws gmail +reply-all MSG_ID --body 'Sounds good to everyone!'
